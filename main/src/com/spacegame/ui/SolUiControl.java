...
public class SolUiControl {
  ...
  public void drawButton(UiDrawer uiDrawer, SolApplication cmp, Color warnCol) {
    if (myScreenArea == null) return;
    Color tint = SolColor.UI_Button_Magneta;
    if (myEnabled) {
      if (isOn()) tint = SolColor.UI_Button_Magneta;
      else if (myMouseHover) tint = SolColor.UI_Button_Magneta;
      else tint = SolColor.UI_Button_Magneta;
    }
