...
public class SolColor {
    ...
    //public static final Color Grey = new Color(28, 24, 27);
    ...
    public static final Color UI_WARN = new Color(.13f, .85f, .92f, 1);
    public static final Color UI_WARN_OLD = new Color(1, .5f, 0, .5f);

    public static final Color UI_Button_Magneta = new Color(.90f, .14f, .36f, 1);
