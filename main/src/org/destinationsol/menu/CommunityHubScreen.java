...
public class CommunityHubScreen implements SolUiScreen {
  ...
  public CommunityHubScreen(MenuLayout menuLayout, TextureManager textureManager, boolean mobile, float r, GameOptions gameOptions) {
    isMobile = mobile;
    myControls = new ArrayList<SolUiControl>();

    mySkinsCtrl = new SolUiControl(menuLayout.buttonRect(-1, 0), true, Input.Keys.S);
